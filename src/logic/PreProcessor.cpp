...
pre_proc_result PreProcessor::reduce_by_grounded(AF &framework, ArrayBitSet &active_args, uint32_t query, bool break_accepted, bool break_rejected,
...
pre_proc_result PreProcessor::process(AF &framework, uint32_t query, bool break_accepted, bool break_rejected, ArrayBitSet &out_reduct,
...
ArrayBitSet PreProcessor::process_only_grounded(AF &framework, list<uint32_t> &out_gr_extension) {
...
pre_proc_result PreProcessor::process_only_grounded(AF &framework, uint32_t query, bool break_acception, bool break_rejection, ArrayBitSet &out_reduct, list<uint32_t> &out_gr_extension)
{
	if (framework.self_attack[query])
	{
		return pre_proc_result::rejected;
